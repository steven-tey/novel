    ...
    getQuickInfoAtPosition (fileName, position) {
        ...
        visitEntryConfig(fileName, position, (entryConfig, declaration)=>{
            ...
            if (value && isPositionInsideNode(position, value)) {
                var _API_DOCS_entryConfig, _API_DOCS_entryConfig_isValid, _API_DOCS_entryConfig_options;
                ...
                if (isValid) {
                    var _API_DOCS_entryConfig_options1, _API_DOCS_entryConfig1, _API_DOCS_entryConfig_getHint;
                    overriden = {
                    ...
                    if (!ALLOWED_EXPORTS.includes(name.text) && !API_DOCS[name.text]) {
                        ...
                        if (value && options) {
                            ...
                            if (ts.isStringLiteral(value) || ts.isNoSubstitutionTemplateLiteral(value)) {
                                var _API_DOCS_name_text, _API_DOCS_name_text_isValid;
                                ...
                                var _API_DOCS_name_text1, _API_DOCS_name_text_isValid1;
                                ...
                                var _API_DOCS_name_text2, _API_DOCS_name_text_isValid2;
                                const v = value.getText();
                                ...
                                var _API_DOCS_name_text3, _API_DOCS_name_text_isValid3;
                                const v = value.getText();
