...
const clientBoundary = {
    ...
    getSemanticDiagnosticsForFunctionExport (source, node) {
        var _node_parameters, _node_parameters_;
        const ts = getTs();
        ...
        if (props && ts.isObjectBindingPattern(props)) {
            for (const prop of props.elements){
                ...
                const typeDeclarationNode = (_type_symbol_getDeclarations = (_type_symbol = type.symbol) == null ? void 0 : _type_symbol.getDeclarations()) == null ? void 0 : _type_symbol_getDeclarations[0];
