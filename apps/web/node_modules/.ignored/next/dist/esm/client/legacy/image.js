...
function defaultLoader(param) {
    ...
    return normalizePathTrailingSlash(config.path) + "?url=" + encodeURIComponent(src) + "&w=" + width + "&q=" + (quality || 75);
}
...
function defaultImageLoader(loaderProps) {
    ...
    throw new Error('Unknown "loader" found in "next.config.js". Expected: ' + VALID_LOADERS.join(", ") + ". Received: " + loaderKey);
}
...
const ImageElement = (param)=>{
    ...
    }), (isLazy || placeholder === "blur") && /*#__PURE__*/ React.createElement("noscript", null, /*#__PURE__*/ React.createElement("img", {
        ...rest,
...
export default function Image(param) {
    ...
    return /*#__PURE__*/ React.createElement(React.Fragment, null, /*#__PURE__*/ React.createElement("span", {
        style: wrapperStyle
    }, hasSizer ? /*#__PURE__*/ React.createElement("span", {
        style: sizerStyle
    }, sizerSvgUrl ? /*#__PURE__*/ React.createElement("img", {
        style: {
            display: "block",
            maxWidth: "100%",
            width: "initial",
        ...
        "aria-hidden": true,
        src: sizerSvgUrl
    }) : null) : null, /*#__PURE__*/ React.createElement(ImageElement, imgElementArgs)), priority ? // Note how we omit the `href` attribute, as it would only be relevant
