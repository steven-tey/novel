...
import { ACTION_NOT_FOUND, ACTION_VERSION_INFO, errorOverlayReducer } from "./internal/error-overlay-reducer";
...
export default function HotReload(param) {
    let { assetPrefix , children , notFound , notFoundStyles , asNotFound  } = param;
    ...
    const handleOnReactError = useCallback((error)=>{
    ...
    }, /*#__PURE__*/ React.createElement(ReactDevOverlay, {
