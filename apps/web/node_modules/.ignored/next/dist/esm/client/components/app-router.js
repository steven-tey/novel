 ...
 */ function Router(param) {
   ...
   */ const changeByServerResponse = useCallback((previousTree, flightData, overrideCanonicalUrl)=>{
    ...
    const navigate = useCallback((href, navigateType, forceOptimisticNavigation)=>{
   ...
   */ const onPopState = useCallback((param)=>{
    ...
    const content = /*#__PURE__*/ React.createElement(RedirectBoundary, null, head, cache.subTreeData, /*#__PURE__*/ React.createElement(AppRouterAnnouncer, {
        tree: tree
    }));
    ...
    /*#__PURE__*/ React.createElement(HotReloader, {
        assetPrefix: assetPrefix,
        ...notFoundProps
    }, content) : /*#__PURE__*/ React.createElement(NotFoundBoundary, notFoundProps, content)))))));
}
