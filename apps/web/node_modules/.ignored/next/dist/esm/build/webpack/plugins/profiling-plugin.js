    ...
    traceCompilationHooks(compiler) {
        ...
        compiler.hooks.compilation.tap({
            ...
            compilation.hooks.succeedModule.tap(pluginName, (module)=>{
                ...
                (_moduleSpansByCompilation_get_get = (_moduleSpansByCompilation_get = moduleSpansByCompilation == null ? void 0 : moduleSpansByCompilation.get(compilation)) == null ? void 0 : _moduleSpansByCompilation_get.get(module)) == null ? void 0 : _moduleSpansByCompilation_get_get.stop();
            });
