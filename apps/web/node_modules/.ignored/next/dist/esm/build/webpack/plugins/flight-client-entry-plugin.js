...
export class FlightClientEntryPlugin {
    ...
    collectClientActionsFromDependencies({ compilation , dependencies  }) {
        ...
        const collectActions = ({ entryRequest , dependency  })=>{
            const collectActionsInDep = (dependencyToFilter)=>{
    ...
    collectComponentInfoFromServerEntryDependency({ entryRequest , compilation , dependency  }) {
        // Keep track of checked modules to avoid infinite loops with recursive imports.
        ...
        const filterClientComponents = (dependencyToFilter)=>{
            var _mod_resourceResolveData, _mod_resourceResolveData1;
            const mod = compilation.moduleGraph.getResolvedModule(dependencyToFilter);
            if (!mod) return;
