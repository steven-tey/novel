    ...
    try {
        ...
        const buildResult = await nextBuildSpan.traceAsyncFn(async ()=>{
            ...
            if (Object.keys(functionsConfigManifest).length > 0) {
                await promises.writeFile(path.join(distDir, SERVER_DIRECTORY, FUNCTIONS_CONFIG_MANIFEST), JSON.stringify(functionsConfigManifest, null, 2));
            }
            ...
            if (ssgPages.size > 0 || appDir) {
                ...
                await promises.writeFile(path.join(distDir, PRERENDER_MANIFEST).replace(/\.json$/, ".js"), `self.__PRERENDER_MANIFEST=${JSON.stringify(JSON.stringify(prerenderManifest))}`, "utf8");
