...
export type RouterNavigate = (href: string, navigateType: 'push' | 'replace', forceOptimisticNavigation: boolean) => void;
...
export type ServerActionDispatcher = (args: Omit<ServerActionAction, 'type' | 'mutable' | 'navigate' | 'changeByServerResponse'>) => void;
