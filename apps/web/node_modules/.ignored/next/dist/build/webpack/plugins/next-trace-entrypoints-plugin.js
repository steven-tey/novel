            ...
            const result = await (0, _nft.nodeFileTrace)([
                ...
                readFile: async (path)=>{
                    if (chunksToTrace.has(path)) {
                        ...
                        const source = (_assets_nodePath_relative_replace = assets[_path.default.relative(outputPath, path).replace(/\\/g, "/")]) == null ? void 0 : _assets_nodePath_relative_replace.source == null ? void 0 : _assets_nodePath_relative_replace.source();
