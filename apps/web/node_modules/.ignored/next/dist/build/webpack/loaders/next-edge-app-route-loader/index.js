...
const EdgeAppRouteLoader = function() {
    ...
    const modulePath = `${appDirLoader}${stringifiedPagePath.substring(1, stringifiedPagePath.length - 1)}?${_constants.WEBPACK_RESOURCE_QUERIES.edgeSSREntry}&${_constants.WEBPACK_RESOURCE_QUERIES.metadata}`;
    return `
