...
const _ampcontext = require("../shared/lib/amp-context");
const _head = require("../shared/lib/head");
const _headmanagercontext = require("../shared/lib/head-manager-context");
const _loadable = /*#__PURE__*/ _interop_require_default(require("../shared/lib/loadable"));
const _loadablecontext = require("../shared/lib/loadable-context");
...
async function renderToHTMLImpl(req, res, pathname, query, renderOpts, extra) {
    ...
    const AppContainer = ({ children  })=>/*#__PURE__*/ _react.default.createElement(_approutercontext.AppRouterContext.Provider, {
            value: appRouter
