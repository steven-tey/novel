...
function getLocaleFromCookie(i18n, headers) {
    ...
    const nextLocale = (_getCookieParser = (0, _apiutils.getCookieParser)(headers || {})()) == null ? void 0 : (_getCookieParser_NEXT_LOCALE = _getCookieParser.NEXT_LOCALE) == null ? void 0 : _getCookieParser_NEXT_LOCALE.toLowerCase();
